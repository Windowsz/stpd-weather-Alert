...
ผ่าน GitHub Actions นอกจากนี้ยังสามารถ **ถามพยากรณ์ฝนของสถานที่อื่นได้ทันทีผ่าน Telegram**
โดยการส่งลิงก์ Google Maps (หรือแชร์พิกัด) เข้าไปในแชท บอทจะแกะพิกัดจากลิงก์แล้วตอบกลับผลพยากรณ์ให้อัตโนมัติ
...
1. เปิด Google Maps เลือกตำแหน่งที่ต้องการเช็ค แล้วกด **แชร์ (Share)**
2. คัดลอกลิงก์ที่ได้ (รองรับทั้งลิงก์เต็ม เช่น `https://www.google.com/maps/@13.75,100.50,15z`
   และลิงก์ย่อ เช่น `https://maps.app.goo.gl/xxxxx`)
3. ส่งลิงก์นั้นไปในแชท Telegram กับ Bot ของคุณ (หรือแชร์ตำแหน่งปัจจุบันผ่านปุ่ม 📎 > Location ก็ได้)
4. รอจนกว่า Workflow จะรันรอบถัดไป (สูงสุด ~30 นาที ตาม Cron) หรือกด **Run workflow** เพื่อให้ตอบกลับทันที
5. บอทจะตอบกลับข้อความพยากรณ์ฝนของพิกัดนั้น พร้อมลิงก์เปิดใน Google Maps
