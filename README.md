...
เพื่อเช็คโอกาสเกิดฝนล่วงหน้า 1 ชั่วโมง และส่งข้อความแจ้งเตือนเข้า Telegram โดยอัตโนมัติทุก 1 นาที
...
> ⚠️ หมายเหตุ: GitHub Actions **ไม่การันตีความแม่นยำของ schedule แบบทุกนาที** — ช่วงที่ระบบ GitHub
> โหลดสูงอาจดีเลย์ได้หลายนาที การตั้งค่าทุก 1 นาทีเป็นค่าที่เร็วที่สุดเท่าที่ทำได้บน GitHub Actions
> แต่ไม่ใช่ real-time 100% เหมือนบอทที่รันบน server ค้างตลอดเวลา
...
จากนั้น:
1. รอจนกว่า Workflow จะรันรอบถัดไป (ปกติภายใน ~1 นาที ตาม Cron แต่ GitHub อาจดีเลย์ได้ในบางช่วง)
...
5. เมื่อรันสำเร็จ ระบบจะเริ่มทำงานอัตโนมัติทุก 1 นาที ตาม Cron `* * * * *`
